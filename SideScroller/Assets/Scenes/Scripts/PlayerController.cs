...
public class PlayerController : MonoBehaviour
{
   [Header("PlayerMovement")]
    ...
    {
        //ground
        isGrounded = Physics.CheckSphere(groundCheck.position, groundCheckRadius, whatIsGround); //checks if you're touching a layer??? idk
    ...
    public void Jump()
    {
        rb.velocity = new Vector3(rb.velocity.x, jumpHeight); //changing velocity on x, and maintaining velocity on y
   ...
   /* public void Attack()
    {
        ...
        RaycastHit hit = Physics.Raycast(transform.position, direction, attackRange, enemyLayer);
