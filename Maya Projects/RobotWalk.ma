...
//Name: RobotWalk.ma
//Last modified: Wed, Oct 18, 2023 11:46:14 AM
//Codeset: 1252
...
fileInfo "UUID" "B70BF5F5-4065-BA29-AA95-30AF4F79F3CC";
createNode transform -s -n "persp";
	rename -uid "5DB14E54-44A3-B868-475B-E493A83E5814";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -37.520940031190705 13.82872466489497 30.151532006776787 ;
	setAttr ".r" -type "double3" -3.6000000000002013 -54.399999999999871 3.4148226024779188e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 48.192988371693332;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.028978052970685873 18.979026981929209 0.44044496333090954 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6A5AC14B-4285-C30F-5E30-248956014369";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F996AEBB-4CD6-5FB2-D193-93A332C168FB";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CCAEACA2-4704-9B6D-9D4D-A9A539872085";
createNode displayLayerManager -n "layerManager";
	rename -uid "CDC67B58-4A1F-E0ED-F026-DD91FB25CE70";
createNode displayLayer -n "defaultLayer";
	rename -uid "DBF1513B-480B-23D1-71BA-0FB2ACBD864E";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0F4BFAFF-42DE-EDB8-F5E8-45843DF95963";
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 0 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_R_foot_secondary_offset|PALBot:PALbot_R_foot_secondary" 
		"rotate" " -type \"double3\" 15.00000000000000178 0 0"
		...
		"translate" " -type \"double3\" 0.0055964546686274033 0.021298320163269595 -0.32274903679819245"
...
createNode animCurveTL -n "PALbot_cog_ctrl_translateY";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -0.8675770951748536 3 -1.5224374025328178
		 6 0 9 0.29277704845290486 12 -0.868 15 -1.522 18 0 21 0.293 24 -0.868;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
...
createNode animCurveTA -n "PALbot_R_IK_footBall_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 -40.000000000000043 3 -10.00000000000005
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 59.999999999999993 3 80 6 40 9 -10 12 -45
		 15 -59.999999999999993 18 -29.999999999999996 21 29.999999999999996 24 59.999999999999993;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
createNode animCurveTA -n "PALbot_R_FK_Elbow_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -60.00000000000005 3 -45.000000000000036
		 6 -45.000000000000036 9 -44.999999999999993 12 -14.999999999999996 15 -5.0000000000000009
		 18 -10.00000000000005 21 -45.000000000000036 24 -60.00000000000005;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 24 -ast 0 -aet 100 ";
	setAttr ".st" 6;
createNode animCurveTA -n "PALbot_L_FK_Elbow_ctrl_rotateX";
	rename -uid "9174E887-4415-8D41-B248-4E9028151311";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -25.000000000000021 3 -10.00000000000002
		 6 -20.000000000000018 9 -35.000000000000007 12 -50.000000000000043 15 -60.00000000000005
		 18 -45.000000000000036 21 -35.00000000000005 24 -25.000000000000036;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
...
connectAttr "PALbot_L_IK_Foot_ctrl_translateZ.o" "PALBotRN.phl[3]";
connectAttr "PALbot_L_IK_Foot_ctrl_translateY.o" "PALBotRN.phl[4]";
connectAttr "PALbot_L_IK_Foot_ctrl_rotateX.o" "PALBotRN.phl[5]";
connectAttr "PALbot_L_IK_Foot_ctrl_rotateY.o" "PALBotRN.phl[6]";
connectAttr "PALbot_L_IK_Foot_ctrl_rotateZ.o" "PALBotRN.phl[7]";
connectAttr "PALbot_L_IK_footBall_ctrl_rotateX.o" "PALBotRN.phl[8]";
connectAttr "PALbot_L_IK_footBall_ctrl_rotateY.o" "PALBotRN.phl[9]";
connectAttr "PALbot_L_IK_footBall_ctrl_rotateZ.o" "PALBotRN.phl[10]";
connectAttr "PALbot_cog_ctrl_translateY.o" "PALBotRN.phl[11]";
connectAttr "PALbot_cog_ctrl_translateX.o" "PALBotRN.phl[12]";
connectAttr "PALbot_cog_ctrl_translateZ.o" "PALBotRN.phl[13]";
...
connectAttr "PALbot_R_FK_Elbow_ctrl_rotateX.o" "PALBotRN.phl[24]";
connectAttr "PALbot_L_ShoulderRotate_ctrl_rotateZ.o" "PALBotRN.phl[25]";
connectAttr "PALbot_L_FK_Elbow_ctrl_rotateX.o" "PALBotRN.phl[26]";
connectAttr "PALbot_R_Engine_ctrl_on_off.o" "PALBotRN.phl[27]";
...
connectAttr "PALbot_R_IK_Foot_ctrl_rotateY.o" "PALBotRN.phl[32]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateZ.o" "PALBotRN.phl[33]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateX.o" "PALBotRN.phl[34]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateY.o" "PALBotRN.phl[35]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateZ.o" "PALBotRN.phl[36]";
