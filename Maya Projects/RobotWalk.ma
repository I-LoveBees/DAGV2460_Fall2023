...
//Name: RobotWalk.ma
//Last modified: Mon, Oct 23, 2023 02:15:08 PM
//Codeset: 1252
...
fileInfo "UUID" "8BC7BF26-4992-E6E4-FFB0-7A82C8539904";
createNode transform -s -n "persp";
	rename -uid "5DB14E54-44A3-B868-475B-E493A83E5814";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -34.948142558643028 18.465400689317597 44.281916050742709 ;
	setAttr ".r" -type "double3" -10.199999999997758 -397.99999999967207 -5.0452272809919001e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 54.388487792645265;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F6368042-40CF-BE59-97D4-43A9B4D40184";
	setAttr -s 21 ".lnk";
	setAttr -s 21 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DF0D5FE0-4612-2628-8416-D59CB482EBC4";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D612DDE2-45A9-C2D6-539F-03B968558220";
createNode displayLayerManager -n "layerManager";
	rename -uid "892491A0-49DA-FB7F-C8A7-CF9E01282F8E";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6B775A35-43DF-73BB-2501-E5B0ABE32BDC";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 49 -ast 0 -aet 100 ";
	setAttr ".st" 6;
